(function (window) {
    ...
    function seed() {
        return {
            ...
            portfolio: [
                { id: 'pf1', title: 'Birthday Terrace Takeover', category: 'Terrace Event', image: '../img/outdoor-terrace-gallery.png', description: 'Private corner setup with grill platters, small chops and cocktail service for 25 guests.', date: '2026-07-18', guests: 25, featured: true },
                { id: 'pf2', title: 'FinTech Team Social', category: 'Private Party', image: '../img/outdoor-terrace.png', description: 'Long outdoor table, bar package and live grill station for a Friday team celebration.', date: '2026-07-05', guests: 18, featured: true },
                { id: 'pf3', title: 'Office Lunch Catering', category: 'Catering', image: '../img/grill-night.png', description: 'Jollof, pepper chicken and snack boxes delivered across New Owerri for 40 staff.', date: '2026-06-22', guests: 40, featured: false },
                { id: 'pf4', title: 'Brand Activation Night', category: 'Brand Night', image: '../img/outdoor-terrace-about.png', description: 'Full terrace branding, live DJ and grill station for a product launch evening.', date: '2026-06-10', guests: 60, featured: true },
                { id: 'pf5', title: 'Golden Hour on the Terrace', category: 'Night Life', image: '../img/menu-4.jpg', description: 'Cocktails, charcoal grills and the terrace at sunset — a regular De Angels moment.', date: '2026-05-30', guests: 0, featured: false },
                { id: 'pf6', title: 'Engagement Dinner Setup', category: 'Private Party', image: '../img/de-angels-platter.png', description: 'Intimate table for two with candles, curated menu and terrace views.', date: '2026-05-14', guests: 2, featured: false }
            ]
        };
    }
