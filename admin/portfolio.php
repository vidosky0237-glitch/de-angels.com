...
<head>
    <meta charset="utf-8">
    <title>Portfolio Vault | De Angels Admin</title>
...
<body class="vault-body vault-dash" data-page="portfolio">
            ...
            <header class="vault-topbar">
                <div class="vault-topbar-start">
                    ...
                    <div class="vault-greeting">
                        <p class="vault-greeting-kicker">Brand &amp; Story</p>
