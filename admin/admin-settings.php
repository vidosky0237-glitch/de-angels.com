...
<head>
    <meta charset="utf-8">
    <title>Admin Settings | De Angels Admin</title>
...
<body class="vault-body vault-dash" data-page="admin-settings">
    ...
    <div class="vault-layout">
        ...
        <div class="vault-main">
            <header class="vault-topbar">
                <div class="vault-topbar-start">
                    ...
                    <div class="vault-greeting">
                        <p class="vault-greeting-kicker">System</p>
            ...
            <main class="vault-content">
                ...
                <div class="manage-card mb-4">
                    <h3 style="font-family:Oswald;margin:0 0 16px;font-size:1.05rem">Session</h3>
                    <p style="color:var(--vault-muted);margin:0 0 8px">Signed in as <strong id="settingsSessionEmail" style="color:var(--vault-text)">—</strong></p>
                    <p style="color:var(--vault-muted);margin:0 0 18px">Session started <span id="settingsSessionAt">—</span></p>
                    <button type="button" class="vault-btn" id="settingsSignOut" style="width:auto;padding:12px 28px;max-width:100%"><i class="fa fa-sign-out-alt"></i> Sign Out</button>
                </div>
