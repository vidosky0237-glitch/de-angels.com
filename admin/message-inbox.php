...
<head>
    <meta charset="utf-8">
    <title>Message Inbox | De Angels Admin</title>
...
<body class="vault-body vault-dash" data-page="message-inbox">
    ...
    <div class="vault-layout">
        ...
        <div class="vault-main">
            <header class="vault-topbar">
                <div class="vault-topbar-start">
                    ...
                    <div class="vault-greeting">
                        <p class="vault-greeting-kicker">Guest Comms</p>
                        <h1>Message Inbox</h1>
                    </div>
                </div>
            ...
            <main class="vault-content">
                ...
                <div id="inboxAlert" class="vault-alert" role="status" style="display:none"></div>

                <section class="res-kpi-strip" aria-label="Inbox snapshot">
                    <button type="button" class="res-kpi" data-msg-filter="unread"><span>Unread</span><strong id="statUnread">—</strong></button>
                    <article class="res-kpi"><span>All messages</span><strong id="statTotal">—</strong></article>
                    <button type="button" class="res-kpi" data-msg-filter="starred"><span>Starred</span><strong id="statStarred">—</strong></button>
                    <button type="button" class="res-kpi" data-msg-filter="event"><span>Events</span><strong id="statEvent">—</strong></button>
                    <button type="button" class="res-kpi" data-msg-filter="table"><span>Tables</span><strong id="statTable">—</strong></button>
                    <button type="button" class="res-kpi" data-msg-filter="catering"><span>Catering</span><strong id="statCatering">—</strong></button>
                    <button type="button" class="res-kpi" data-msg-filter="takeaway"><span>Takeaway</span><strong id="statTakeaway">—</strong></button>
                </section>

                <div class="manage-card mb-4">
                    <div class="res-table-tools">
                        <div class="res-filters">
                            <button type="button" class="res-filter active" data-msg-filter="all">All</button>
                            <button type="button" class="res-filter" data-msg-filter="unread">Unread</button>
                            <button type="button" class="res-filter" data-msg-filter="starred">Starred</button>
                            <button type="button" class="res-filter" data-msg-filter="event">Event</button>
                            <button type="button" class="res-filter" data-msg-filter="table">Table</button>
                            <button type="button" class="res-filter" data-msg-filter="catering">Catering</button>
                            <button type="button" class="res-filter" data-msg-filter="takeaway">Takeaway</button>
                            <button type="button" class="res-filter" data-msg-filter="replied">Replied</button>
                            <button type="button" class="res-filter" data-msg-filter="archived">Archived</button>
                        </div>
                        <div class="inbox-tools">
                            <input type="search" id="inboxSearch" placeholder="Search name, email, ref…" aria-label="Search inbox">
                            <button type="button" class="manage-btn" id="inboxMarkAll">Mark all read</button>
                        </div>
                    </div>
                    <p style="color:var(--vault-muted);margin:0;font-size:13px">Website contact form messages land here live. Convert a thread into a reservation when the guest is ready to book.</p>
                </div>

                <div class="manage-split">
                    <div id="messageList"></div>
                    <div id="messageDetail"><div class="empty-state"><i class="fa fa-envelope-open d-block"></i>Select a message to read</div></div>
                </div>
            </main>
        </div>
    </div>
    <nav class="vault-mobile-dock" aria-label="Quick navigation">
        ...
        <a href="message-inbox.php" class="dock-item active" data-nav="message-inbox"><i class="fa fa-envelope"></i><span>Inbox</span></a>
